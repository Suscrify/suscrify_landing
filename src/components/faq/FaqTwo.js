              ...
              <div className="accordion-item border border-2 active">
                ...
                >
                  <div className="accordion-body">
                    ...
                    information. Holisticly fabricate timely initiatives
                    vis-a-vis high-quality imperatives. Continually deploy
              ...
              <div className="accordion-item border border-2">
                ...
                >
                  <div className="accordion-body">
                    ...
                    convergence and parallel sources. Enthusiastically architect
